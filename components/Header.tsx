          ...
          <Link href="/" className="-m-1.5 p-1.5">
            ...
            <div className="group flex items-center space-x-2">
              ...
              <div className="leading-tight">
                <div className="text-xl font-bold text-gray-900">Metrics2Impact</div>
                <div className="text-[11px] tracking-wide text-gray-600/80 opacity-90 transition-opacity duration-200 group-hover:opacity-100">
